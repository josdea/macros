...
Sub iterateSlideShapes(sld As Slide)
    ...
    If hasLearnerNotes = False Then
        createSlideShapeTextbox sld, -288, 0, 252, 540, "LearnerNotes", "Learner Notes", 12
    End If
    
    If hasMinutes = False Then
        createSlideShapeTextbox sld, 0, -72, 144, 36, "Minutes", "", 12
    End If
    
    If hasObjective = False Then
        createSlideShapeTextbox sld, 180, -72, 216, 36, "Objective", "", 12
    End If
